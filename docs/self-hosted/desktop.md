...
Choose [Server Deploy](/self-hosted/docker) instead when you need shared access, production uptime, remote users, or messaging channels that should keep running while your desktop is offline.
...
For runtime details, see [Workspace Backends](/self-hosted/workspace-backends).
